...
root = tk.Tk()
root.title("XOR, OR, NOR, AND Gate Calculator")
root.geometry("300x250")  # Set window size (width x height)
...
# Create buttons to calculate XOR, OR, NOR, and AND gate results
...
calculate_xor_button.grid(row=2, column=0)
calculate_or_button.grid(row=2, column=1)
calculate_nor_button.grid(row=3, column=0)
calculate_and_button.grid(row=3, column=1)
