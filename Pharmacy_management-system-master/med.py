...
class Pharmacy:
    def __init__(self, root):
        ...
        down_buttonframe.place(x=0, y=462, width=1350, height=56)
        ...
        conn = mysql.connector.connect(host="localhost", user="root", password="akash9458", database="pharmacy")
        ...
        medname_label = Label(left_smallframe, text="Medicine Name :", padx=2, pady=4, font=("times new roman", 13, "bold"), bg="grey")
        ...
        values_for_medname_combobox = ('Select', *medicine_names)

        self.medname_combo = ttk.Combobox(left_smallframe, textvariable=self.medicine_var, width=22, font=(
            "times new roman", 13, "bold"), state="readonly")
        self.medname_combo["values"] = values_for_medname_combobox
        ...
        price_label = Label(left_smallframe, text=" Medicine Price :", padx=2, pady=4, font=(
            "times new roman", 13, "bold"), bg="grey")
        ...
        qt_label = Label(left_smallframe, text=" Medicine Quantity :", padx=2, pady=4, font=(
            "times new roman", 13, "bold"), bg="grey")
        qt_label.grid(row=2, column=2)

        self.qt_entry = Entry(left_smallframe, textvariable=self.Medicine_var, width=28, font=(
            "times new roman", 13, "bold"), fg="black", bg="white")
        ...
        down_frame.place(x=0, y=518, width=1350, height=282)

        ########## scrollbar in down frame ########
        scroll_frame = Frame(down_frame, bd=2, relief=RIDGE, bg="white")
        scroll_frame.place(x=0, y=0, width=1330, height=262)
        ...
        self.info_table = ttk.Treeview(scroll_frame, column=("ref no", "comp name", "type", "medi name", "lot no", "issue", "exp",
                                       "uses", "side effect", "warning", "dosage", "price", "Medicine"), xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
        ...
        self.info_table.heading("Medicine", text="Medicine Qt.")
        ...
        self.info_table.column("Medicine", width=100)
    ...
    def addmedicine(self):
        if self.refno_var.get() == "" or self.lotno_var.get() == "" or self.typemed_var.get() == "":
            ...
            new_cursor.execute("INSERT INTO Information (REF_NO, COMPANY_NAME, TYPE_OF_MED, MED_NAME, LOT_NO, ISSUE_DT, EXP_DT, USES, SIDE_EFFECT, PRECAUTION, DOSAGE, PRICE, Medicine) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
            (
            self.refno_var.get(),
